...
<link rel="stylesheet" href="<%=webPath%>/jsp/bdo/procdef/html/skin/css/branch.css" />
...
<script type="text/javascript" src="<%=webPath%>/jsp/bdo/procdef/html/condition/branch.js"></script>
