...
<script type="text/javascript" src="<%=webPath%>/jsp/bdo/procdef/html/form/formauth.js"></script>
...
<body>
    ...
    <div id="content" class="right">
        ...
        <table>
            <thead>
                <tr>
                    <th style="width:160px;text-align:left;text-align: left;padding-left: 10px;">表单域名称</th>
