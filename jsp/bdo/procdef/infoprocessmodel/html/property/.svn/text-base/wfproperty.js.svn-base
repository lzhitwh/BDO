...
(function($) {
	WFProp.showProcessProperty=function(param_data){
		$.ajax({
			...
			url : WFlow.fullWebPath
					+ "/jsp/bdo/procdef/infoprocessmodel/html/property/process/procproperty.jsp",
			data : {},
			dataType : "html",
			async : false,
			...
			error : function() {
				showDialog("alert","加载流程属性页面出错!", "提示信息", 300);
			}
		});
	}
	...
	WFProp.showTaskProperty = function(param_data){
		$.ajax({
			type : "POST",
			url : WFlow.fullWebPath
					+ "/jsp/bdo/procdef/infoprocessmodel/html/property/task/taskproperty.jsp",
			data : {},
			dataType : "html",
			async : false,
			success : function(data) {
			...
			error : function() {
				showDialog("alert","加载环节属性页面出错!", "提示信息", 300);
			}
		});
	}
	WFProp.showGatewayProperty=function(param_data){
		$.ajax({
			type : "POST",
			url : WFlow.fullWebPath
					+ "/jsp/bdo/procdef/infoprocessmodel/html/property/gateway/gatewayproperty.jsp",
			data : {},
			dataType : "html",
			async : false,
			success : function(data) {
	...
	WFProp.showCallProperty=function(param_data){
		$.ajax({
			type : "POST",
			url : WFlow.fullWebPath
					+ "/jsp/bdo/procdef/infoprocessmodel/html/property/subproc/subprocess.jsp",
			data : {},
			dataType : "html",
			async : false,
			success : function(data) {
