(function($) {
	...
	WFGraph.drawLane = function(nodeInfo) {
		...
		var g_lane = WFGraph.canvas.rect(0, 0, nodeInfo.width, nodeInfo.height).attr(nodeInfo.attr).hide();
		var g_drag = WFGraph.canvas.rect(0, 0, 2, nodeInfo.height).attr({fill:"#fff",stroke : "#fff",'stroke-width' :4}).hide();
